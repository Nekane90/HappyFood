...
public class ModificarUsuarioController {
    ...
    @FXML
    private ComboBox<String> comboDieta;
    @FXML
    ...
    @FXML
    private ToggleButton btnVerPassword;
    @FXML
    private ProgressBar progressFuerza;
    @FXML
    ...
    public void initialize() {
        ...
        if (usuario != null) {
            ...
            // CARGA DE CONTRASEÑA EN TEXTO PLANO
            ...
            // Evaluar la fuerza inicialmente
            evaluarFuerza();
        }
    }
    ...
    public void guardarCambios(ActionEvent event) {
        ...
        // 3. Procesar Dieta e Intolerancias
        ...
        // 4. Conexión y Update en Base de Datos
        ...
        if (con != null) {
            ...
            try (PreparedStatement stmt = con.prepareStatement(sql)) {
                ...
                stmt.setString(3, passwordFinal); // SE GUARDA SIN ENCRIPTAR
